...
```bash
pip install git-remote-gdrive
```

## Configuration

Before using `git-remote-gdrive`, you need to set the `GDRIVE_CREDENTIALS_PATH` environment variable to the absolute path of your `credentials.json` file.
